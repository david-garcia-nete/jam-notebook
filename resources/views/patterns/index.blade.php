                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg p-6 space-y-4">
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <div class="flex items-center gap-3 text-sm">
                                <a href="{{ route('patterns.show', $pattern) }}" class="text-gray-700 hover:text-gray-900">View</a>
                                @if ($pattern->notation_url)
                                    <a href="{{ $pattern->notation_url }}" target="_blank" rel="noopener noreferrer" class="text-sky-600 hover:text-sky-800">Open notation</a>
                                @endif
                        ...
                        @if (filled(trim((string) $pattern->notes)))
                            <div>
                                ...
                                <div class="relative mt-1 max-h-48 overflow-hidden rounded-md border border-gray-200 bg-gray-50 p-4">
                                    <pre class="m-0 text-sm text-gray-800 font-mono whitespace-pre leading-relaxed">{{ $pattern->notes }}</pre>
